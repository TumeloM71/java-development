...
public class UserInterface {
    ...
    public void processSellRequest() throws IOException {
        ...
        int vin = Utilities.getIntValue(input.nextLine().trim());
        System.out.println(vin);
        Vehicle v = dealership.getByVIN(vin);
        System.out.println(v);

        int loanChoice = showConfirmDialog(null,"Would like to take a loan?");
        boolean isFinanced = loanChoice == 0;
        if (v!=null)
            dealership.sellVehicle(name,email,v,isFinanced);
    }

    public void processLeaseRequest() throws IOException {
        Scanner input = new Scanner(System.in);
        System.out.println("Enter your name");
        String name = input.nextLine().trim();
        System.out.println("Enter your email");
        ...
        if (v!=null)
            dealership.leaseVehicle(name,email,v);
    }
