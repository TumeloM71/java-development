...
public class NeighbourhoodLibrary  {
    ...
    public static void main(String[] args) {
        ...
        int GUIselection = JOptionPane.showConfirmDialog(null, "Would you like to use a GUI?");

        //Runs the GUI class if the user selects 'Yes'
        if (GUIselection == 0) {
            MyGUI myGUI = new MyGUI(books);
            myGUI.mainDisplay();
        }
        //Runs the CLI if the user selects No
